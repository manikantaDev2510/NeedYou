...
export default function UserProfileAvatarEdit({ close }) {
      ...
      <div className='bg-white max-w-sm w-full rounded p-4 flex flex-col items-center justify-center'>
        ...
        <form onSubmit={handleSubmit}>
          <label htmlFor='uploadProfile'>
            <div className='border bg-blue-500 hover:bg-blue-600 text-white transition mb-2 cursor-pointer hover:bg-primary-200 px-4 py-2 rounded text-sm my-3'>
              {
