...
//           <InfoBlock title="Description" content={productData.description} />
//           <InfoBlock title="Unit" content={productData.unit} />
//           {Object.entries(productData.more_details || {}).map(([key, val], i) => (
...
//         <p className="">{productData.unit}</p>
//         <Divider />
...
//             desc="Get your orer delivered to your doorstep at the earliest from dark stores near you."
//           />
//           <WhyShopFeature
//             img={image2}
//             title="Best Prices & Offers"
//             desc="Best price destination with offers directly from the nanufacturers."
//           />
//           <WhyShopFeature
//             img={image3}
...
//           <InfoBlock title="Description" content={productData.description} />
//           <InfoBlock title="Unit" content={productData.unit} />
//           <InfoBlock title="Type" conten={productData.type} />
    ...
    <section className="container mx-auto p-4 grid lg:grid-cols-2">
      ...
      <div className="space-y-4">
        ...
        <div className="hidden lg:block space-y-2">
          ...
          <InfoBlock title="Country Of Origin" content={productData.countryOfOrigin} />
          <InfoBlock title="FSSAI License" content={productData.fssaiLicense} />
          <InfoBlock title="Customer Care Details" content={productData.customerCareDetails} />
          <InfoBlock title="Return Policy" content={productData.returnPolicy} />
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            {productData.discount > 0 && (
              <>
                ...
                <span className="text-green-600 font-bold">{productData.discount}% Off</span>
              </>
            )}
          </div>
        </div>
